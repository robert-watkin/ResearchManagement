...
public class NewAccount extends javax.swing.JFrame {
    ...
    private void createAccountButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createAccountButtonActionPerformed
        ...
        // prepare sql string
        String sqlInsert = "INSERT INTO tbl_accounts (FirstName, LastName, Email, DOB, Password, Role) VALUES (?, ?, ?, ?, ?, ?)";
        ...
        try (Connection conn = Database.Connect();
            ...
            insertPs.setString(5, String.valueOf(passwordField.getPassword()));
            insertPs.setString(6, String.valueOf(roleComboBox.getSelectedItem()));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NewAccount(new Account(-1, null, null, null, null, null)).setVisible(true);
            }
        });
    }
