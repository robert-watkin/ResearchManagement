...
public class NewCustomer extends javax.swing.JFrame {
     ...
     */
    public NewCustomer(Account acc) {
        initComponents();
    ...
    private void initComponents() {
        ...
        createCustomerButton.setText("Create Account");
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        ...
                        .addGap(0, 30, Short.MAX_VALUE))
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(createCustomerButton, javax.swing.GroupLayout.PREFERRED_SIZE, 114, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void createCustomerButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createCustomerButtonActionPerformed
        ...
        try (Connection conn = Database.Connect();
            ...
            insertPs.setString(3, String.valueOf(DOBField.getText())); // dates stored as string as SQLite does not have a date datatype
            insertPs.setString(4, String.valueOf(emailField.getText()));

            // execute the sql query
            int row = insertPs.executeUpdate();
            System.out.println("Customer inserted into row " + row);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NewCustomer(new Account(-1, null, null, null, null, null)).setVisible(true);
            }
        });
    }
